...
export function Manifesto() {
  return (
    <section className="relative container-x py-[clamp(80px,12vw,160px)] streak-bg">
      <div className="max-page max-w-[1280px] mx-auto">
        ...
        <h2 className="font-display text-ink leading-[0.86] text-[clamp(56px,11vw,170px)]">
          {[
            ["Real ", "kicks."],
            ["Real ", "video."],
            ["No ", "fakes."],
            ...
            <span key={li} className="block overflow-hidden">
              <motion.span
                ...
                transition={{ duration: 1.1, ease: [0.22, 1, 0.36, 1], delay: li * 0.08 }}
              >
                {line.map((seg, si) =>
